...
RSpec.describe Cosense::Project do
  ...
  describe '.parse' do
    it 'is a JSON' do
      ...
      expect(project.users).to eq [Cosense::User.new(id: '12ab34cd', displayName: 'テスト太郎', name: 'test_taro',
                                                     email: 'taro@example.jp')]
      page = project_hash[:pages][0]
      expect(project.pages).to eq [Cosense::Page.new(id: '673c819d2c4025543126d6af', title: 'テストページ1',
                                                     created: 1_732_018_000, updated: 1_732_020_000, views: 12, lines: page[:lines])]
    end
  end
