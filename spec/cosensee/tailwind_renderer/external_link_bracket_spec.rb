  ...
  describe '#render' do
    context 'when anchor is not nil' do
      it 'convert ExternalLinkBracket to HTML' do
        content = Cosensee::Node::ExternalLinkBracket.new(content: ['https://example.com/link foo'], link: 'https://example.com/link', anchor: 'foo', raw: '[https://example.com/link foo]')
    ...
    context 'when anchor is nil' do
      it 'convert ExternalLinkBracket to HTML' do
        content = Cosensee::Node::ExternalLinkBracket.new(content: ['https://example.com/link'], link: 'https://example.com/link', anchor: nil, raw: '[https://example.com/link]')
