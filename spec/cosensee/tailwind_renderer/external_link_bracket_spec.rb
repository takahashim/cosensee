  ...
  describe '#render' do
    context 'when anchor is not nil' do
      it 'convert ExternalLinkBracket to HTML' do
        content = Cosensee::ExternalLinkBracket.new(content: ['https://example.com/link foo'], link: 'https://example.com/link', anchor: 'foo')
    ...
    context 'when anchor is nil' do
      it 'convert ExternalLinkBracket to HTML' do
        content = Cosensee::ExternalLinkBracket.new(content: ['https://example.com/link'], link: 'https://example.com/link', anchor: nil)
